"use sctrict";
/* классы */
function HashStorage(locStorageName) { //описание класса
...
drinkStorage.getFromLocStorage("DrinkStorage");

var dishStorage = new HashStorage("DishStorage");
dishStorage.getFromLocStorage("DishStorage");
